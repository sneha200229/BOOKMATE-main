...
const Follow = ()=>{
  ...
  const handleCloseDialog1 = () => {
    ...
    return(
            ...
            <Grid item xs={4}>
            <Typography width='80%' margin={'0 auto'} sx={{color:'#545F71'}}>City:
            <span style={{ color: 'black' }}>{localStorage.getItem('CITY')}</span>
            ...
            <Grid item xs={4}>
            <Typography width='80%' margin={'0 auto'} sx={{color:'#545F71'}}>Bio:
            <span style={{ color: 'black' }}>{localStorage.getItem('BIO')}</span>
              </Typography>
            </Grid>
